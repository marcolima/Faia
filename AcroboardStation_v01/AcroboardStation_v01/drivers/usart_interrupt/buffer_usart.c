 ...
 */
bool USART_TXBuffer_FreeSpace(/*volatile*/ USART_data_t * usart_data)
{
 ...
 */
bool USART_TXBuffer_PutByte(/*volatile*/ USART_data_t * usart_data, uint8_t data)
{
 ...
 */
uint8_t USART_RXBuffer_GetByte(/*volatile*/ USART_data_t * ud)
{
 ...
 *  \param usart_data      The USART_data_t struct instance.
 */
bool USART_RXComplete(/*volatile*/ USART_data_t * usart_data)
{
	/*volatile*/ USART_data_t * const ad = usart_data;
 ...
 *  \param usart_data      The USART_data_t struct instance.
 */
void USART_DataRegEmpty(/*volatile*/ USART_data_t * usart_data)
{
	/*volatile*/ USART_data_t * const ad = usart_data;
